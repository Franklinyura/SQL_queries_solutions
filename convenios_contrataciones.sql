-- QUERY PARA GENERAR EL INCURRIDO DE USO DE COBERTURAS 
SELECT
...
FROM DIM_COBERTURA
    ...
    WHERE HECHO_RECLAMACIONES.FECHA_APERTURA BETWEEN '1-1-2021' AND '12-1-2021'
        AND COD_TIPO_COBERTURA IN ('711', '712','713')
        -- AND DIM_COBERTURA.COD_COBERTURA = '881401'
        AND DIM_ESTATUS.COD_ESTATUS NOT IN ('52','213')
        AND DIM_RECLAMANTE.COD_RECLAMANTE = '1689137';


-- QUERY PARA GENERAR LA FRECUENCIA DE USO DE COBERTURAS EN RESUMEN
SELECT
    DIM_COBERTURA.COD_COBERTURA,
    DIM_COBERTURA.DESC_COBERTURA,
